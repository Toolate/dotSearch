<%@ Page Language="C#" AutoEventWireup="true" Inherits="index_v2" Codebehind="index_v2.aspx.cs" %>
...
<body>
    ...
    <div id="main">
        <div id="menu">
            <a class="selected" href="">Web</a> | <a href="img" class="unselected">Images</a> | <a href="" class="unselected">
                Vidéos</a> | <a href="" class="unselected">News</a>
        </div>
